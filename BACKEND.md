...
```
Arquitetura.Shared/Arquitetura.SharedKernel/
```
...
```csharp
// Arquitetura.Shared/Arquitetura.SharedKernel/Primitives/Entity.cs
...
```csharp
// Arquitetura.Shared/Arquitetura.SharedKernel/Primitives/ValueObject.cs
...
```csharp
// Arquitetura.Shared/Arquitetura.SharedKernel/Common/Result.cs
...
```csharp
// Arquitetura.Shared/Arquitetura.SharedKernel/Common/Error.cs
...
```
Arquitetura.Backend/Produtos/Produtos.Domain/
Arquitetura.Backend/Pedidos/Pedidos.Domain/
```
...
```csharp
// Arquitetura.Backend/Produtos/Produtos.Domain/Entities/Produto.cs
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Domain/Entities/Pedido.cs
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Domain/Entities/ItemPedido.cs
...
```
Arquitetura.Backend/Produtos/Produtos.Application/
Arquitetura.Backend/Pedidos/Pedidos.Application/
```
...
```
Arquitetura.Backend/Produtos/Produtos.Infrastructure/
Arquitetura.Backend/Pedidos/Pedidos.Infrastructure/
```
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Infrastructure/InfrastructureServiceExtensions.cs
...
```
Arquitetura.Backend/Produtos/Produtos.Api/
Arquitetura.Backend/Pedidos/Pedidos.Api/
```
...
**Produtos API:**
```csharp
// Arquitetura.Backend/Produtos/Produtos.Api/Program.cs
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Api/Program.cs
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Application/Features/Commands/CriarPedido/CriarPedidoCommandHandler.cs
...
```csharp
// Arquitetura.Backend/Produtos/Produtos.Infrastructure/Messaging/PedidoConfirmadoConsumer.cs
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Application/Abstractions/IViaCepClient.cs
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Application/Features/Queries/ConsultarCep/ConsultarCepQuery.cs
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Infrastructure/Http/ViaCepClient.cs
...
```csharp
// Arquitetura.Backend/Pedidos/Pedidos.Api/Endpoints/CepEndpoints.cs
...
services:
  ...
  produtos-api:
    build:
      context: .
      dockerfile: Arquitetura.Backend/Produtos/Produtos.Api/Dockerfile
    environment:
  ...
  pedidos-api:
    build:
      context: .
      dockerfile: Arquitetura.Backend/Pedidos/Pedidos.Api/Dockerfile
    environment:
...
*Documentação gerada para o backend do projeto. Para a documentação do frontend, consulte `FRONTEND.md`. Para a visão geral completa da solução, consulte `README.md` na raiz.*